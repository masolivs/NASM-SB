...
main:
    ...
    ; argumentos entram na pilha de trás pra frente
    push hdr
    push fmt_str
    call printf
    add  esp, 8      ; 2 pushes × 4 bytes

    push soma(6,7)   ; expande para 13 em tempo de montagem
    push msg_def1
    push fmt_int
    call printf
    add  esp, 12     ; 3 pushes × 4 bytes
    ...
    mov  eax, GaTo   ; GaTo é reconhecido pelo %idefine, vale 1
    push eax
    push msg_idef
    push fmt_int
    call printf
    ...
    ; CHAR_1 e CHAR_3 são um byte ASCII ('N' e 'S')
    mov  al, CHAR_1
    ...
    ; restaura ebp e retorna com código 0
    mov  eax, SYS_OK
    pop  ebp
    ret
